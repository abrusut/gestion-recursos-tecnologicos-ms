...
use App\Controller\UbicacionGlobalFilterAction;
 ...
 *                      "access_control"="is_granted('ROLE_ADMIN')",
 *                      "method"="GET",
 *                      "path"="/ubicacions/globalFilter",
 *                      "controller"=UbicacionGlobalFilterAction::class,
...
class Ubicacion
{
     ...
     * @var string
     * @Groups({"get", "post","put"})
     * @ORM\Column(name="detalle", type="string", length=60,nullable=false)
     * @Assert\NotBlank()
     * @Assert\Length(min = 1)
     * @Assert\Length( max = 60)
     * @Assert\NotNull()
